 ...
 * Copy: ../plan/00-orientation.md. Every slide uses the placeholder icon; the
 * TODO(icon) comment records the intended icon for the later curation pass.
 */
...
export const orientation: LearnSection = {
  ...
  slides: [
    {
      // TODO(icon): a lightbulb / question mark resolving into an idea
    ...
    {
      // TODO(icon): a gift / three stacked cards (shop, play, health)
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): two arrows — one pointing at a dollar sign, one at a person
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): an hourglass / a clock wrapped around a phone
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): an open book beside a small running gear / prototype
      icon: ICONS.slidePlaceholder,
