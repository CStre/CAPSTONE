 ...
 * Copy: ../plan/03-the-human-cost.md (Synthesis 03). Placeholder icons.
...
export const theHumanCost: LearnSection = {
  ...
  slides: [
    {
      // TODO(icon): a heart with a hairline crack / a medical cross over a phone
    ...
    {
      // TODO(icon): a mirror showing a distorted reflection / a filtered face
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): a rain cloud over a small figure / a downward mood line
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): a plate/scale with a warning / a fork crossed out
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): a phone with a magnet / a hand that can't put it down
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): a fragile thread / a help-line lifeline
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): a moon with a phone glow / a crossed-out "Z"
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): a swipe gesture / a profile card being rated
      icon: ICONS.slidePlaceholder,
    ...
    {
      // TODO(icon): a storm of sharp speech bubbles / a thermometer of "outrage"
      icon: ICONS.slidePlaceholder,
